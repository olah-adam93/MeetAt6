...
const AboutView = () => {
  return <div className='about-container'>
    ...
    to the course of the Progmatic School. After a long period, they learnt the basics of the frontend programming, met a the way of the coding or something more. At the end of 
    the course, they had to create their frist project, as some kind of final exam. Their goal was to create an online page, were people could browse between events, in 
    various theme. Just a little help for those who want to join communities, or just want to spend somehow their free tirm. The time was short, they worked a lot, but 
    in the end, the project coming alive. Or at least they hoped, becouse when I wrote this we were only in the middle of the progress. But be positive, we will prevail. </div>
    </div>;
