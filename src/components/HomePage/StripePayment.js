...
const getStripe = () => {
    if (!stripePromise) {
        stripePromise = loadStripe('pk_test_51KuevLHfpw3nPJ5tDhBVqdAnh9HwL4QBwWei4DvG7tbrPAAfFSzTCUjakpTfT74PIHqvbbSDkOBxGVe5pfmdUPIU00Zrip53pp');
    }
    return stripePromise;
};


const StripePayment = ({eventValue}) => {
  ...
  return (
    <button onClick={redirectToCheckout} disabled={isLoading}>Pay now</button>
  )
